...
public class HesuanbaogaoServiceImpl extends ServiceImpl<HesuanbaogaoDao, HesuanbaogaoEntity> implements HesuanbaogaoService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<HesuanbaogaoEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<HesuanbaogaoEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<HesuanbaogaoEntity> wrapper) {
