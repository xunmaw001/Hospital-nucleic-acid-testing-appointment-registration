<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检测日期" prop="jianceriqi">
          <el-input v-model="ruleForm.jianceriqi" 
              placeholder="检测日期" clearable  :readonly="ro.jianceriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检测日期" prop="jianceriqi">
              <el-input v-model="ruleForm.jianceriqi" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.hesuanbaogao" label="核酸报告" prop="hesuanbaogao">
          <file-upload
          tip="点击上传核酸报告"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.hesuanbaogao?ruleForm.hesuanbaogao:''"
          @change="hesuanbaogaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.hesuanbaogao" label="核酸报告" prop="hesuanbaogao">
            <el-button type="text" size="small" @click="download(ruleForm.hesuanbaogao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="核酸结果" prop="hesuanjieguo">
        ...
        <div v-else>
          <el-form-item class="input" label="核酸结果" prop="hesuanjieguo">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jianceriqi = true;
          ...
          if(o=='hesuanbaogao'){
            this.ruleForm.hesuanbaogao = obj[o];
	    this.ro.hesuanbaogao = true;
            continue;
          }
          if(o=='hesuanjieguo'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.hesuanjieguoOptions = "阳性,阴性".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	if(this.ruleForm.hesuanbaogao!=null) {
		this.ruleForm.hesuanbaogao = this.ruleForm.hesuanbaogao.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    hesuanbaogaoUploadChange(fileUrls) {
	this.ruleForm.hesuanbaogao = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
