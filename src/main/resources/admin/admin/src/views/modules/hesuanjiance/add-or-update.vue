<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="医院编号" prop="yiyuanbianhao">
          <el-select :disabled="ro.yiyuanbianhao" @change="yiyuanbianhaoChange" v-model="ruleForm.yiyuanbianhao" placeholder="请选择医院编号">
            <el-option
                v-for="(item,index) in yiyuanbianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医院等级" prop="yiyuandengji">
          <el-input v-model="ruleForm.yiyuandengji" 
              placeholder="医院等级" clearable  :readonly="ro.yiyuandengji"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="检测方式" prop="jiancefangshi">
          <el-select :disabled="ro.jiancefangshi" v-model="ruleForm.jiancefangshi" placeholder="请选择检测方式">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="号数" prop="haoshu">
          <el-input v-model="ruleForm.haoshu" 
              placeholder="号数" clearable  :readonly="ro.haoshu"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/yiyuanxinxi/yiyuanbianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.yiyuanbianhaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    yiyuanbianhaoChange () {
      this.$http({
        url: `follow/yiyuanxinxi/yiyuanbianhao?columnValue=`+ this.ruleForm.yiyuanbianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.yiyuanmingcheng){
                this.ruleForm.yiyuanmingcheng = data.data.yiyuanmingcheng
              }
              if(data.data.yiyuandizhi){
                this.ruleForm.yiyuandizhi = data.data.yiyuandizhi
              }
              if(data.data.yiyuandengji){
                this.ruleForm.yiyuandengji = data.data.yiyuandengji
              }
        } else {
          this.$message.error(data.msg);
        }
