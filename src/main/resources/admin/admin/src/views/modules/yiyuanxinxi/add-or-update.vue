  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yiyuanbianhao" label="医院编号" prop="yiyuanbianhao">
              <el-input v-model="ruleForm.yiyuanbianhao" 
                placeholder="医院编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="医院等级" prop="yiyuandengji">
          <el-select :disabled="ro.yiyuandengji" v-model="ruleForm.yiyuandengji" placeholder="请选择医院等级">
            <el-option
                v-for="(item,index) in yiyuandengjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="医院等级" prop="yiyuandengji">
	      <el-input v-model="ruleForm.yiyuandengji"
                placeholder="医院等级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
